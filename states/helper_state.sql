...
--
-- Host: localhost:3306
-- Generation Time: May 23, 2017 at 09:34 PM
...
--
-- Table structure for table `helper_state`
--
...
--
-- Dumping data for table `helper_state`
--

INSERT INTO `helper_state` (`ID`, `name`, `country_id`) VALUES
...
--
-- Indexes for table `helper_state`
--
ALTER TABLE `helper_state`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `helper_state`
--
ALTER TABLE `helper_state`
